...
public static class Seed
{
    ...
    [
        Stop("s-1", "DO-2026-0801", "SO-9910231", "zone-1", "บจก. นครสวรรค์การค้า", "อ.เมือง จ.นครสวรรค์", 150, 3000, 10.5, 0, [15.7047, 100.1372], "WSK", "2026-07-28", "2026-07-31"),
        Stop("s-2", "DO-2026-0802", "SO-9910232", "zone-2", "หจก. พิจิตรซัพพลาย", "อ.เมือง จ.พิจิตร", 200, 4000, 12.0, 15500, [16.4429, 100.3487], "WSK", "2026-08-01", "2026-08-07"),
        Stop("s-3", "DO-2026-0803", "SO-9910233", "zone-3", "ร้านพิษณุโลกมาร์ท", "อ.เมือง จ.พิษณุโลก", 100, 1500, 6.0, 0, [16.8211, 100.2659], "WPD", "2026-08-02", "2026-08-08"),
        Stop("s-4", "DO-2026-0804", "SO-9910234", "zone-4", "บจก. อยุธยาเทรดดิ้ง", "อ.พระนครศรีอยุธยา จ.พระนครศรีอยุธยา", 80, 1200, 4.5, 8200, [14.3532, 100.5689], "WPD", "2026-07-20", "2026-07-25", deliverTo: "หน่วยงานก่อสร้าง ไซต์อยุธยา"),
        Stop("s-5", "DO-2026-0805", "SO-9910235", "zone-5", "สหกรณ์ลพบุรี", "อ.เมือง จ.ลพบุรี", 120, 2400, 8.0, 0, [14.7995, 100.6534], "WWP", "2026-08-03", "2026-08-09"),
        Stop("s-6", "DO-2026-0806", "SO-9910236", "zone-6", "บจก. สระบุรีวัสดุ", "อ.เมือง จ.สระบุรี", 90, 1800, 5.5, 4300, [14.5289, 100.9101], "WWP", "2026-08-03", "2026-08-10"),
        Stop("s-7", "DO-2026-0807", "SO-9910237", "zone-7", "ชลบุรี ซูเปอร์มาร์เก็ต", "อ.ศรีราชา จ.ชลบุรี", 160, 3200, 11.0, 0, [13.1731, 100.9310], "WSK", "2026-07-15", "2026-07-18"),
        Stop("s-8", "DO-2026-0808", "SO-9910238", "zone-8", "ระยองฟู้ดส์", "อ.เมือง จ.ระยอง", 110, 2100, 7.5, 12800, [12.6814, 101.2816], "WPD", "2026-08-04", "2026-08-11", deliverTo: "คลังกระจายสินค้า ระยอง"),
    ];
    ...
    [
        ...
        new Manifest
        {
            ...
            Stops =
            [
                Stop("h-5", "DO-2026-0781", "SO-9910201", "zone-1", "บจก. นครสวรรค์การค้า", "อ.เมือง จ.นครสวรรค์", 140, 2800, 9.5, 0, [15.7047, 100.1372], "WSK", "2026-08-04", "2026-08-06"),
                Stop("h-6", "DO-2026-0782", "SO-9910202", "zone-3", "ร้านพิษณุโลกมาร์ท", "อ.เมือง จ.พิษณุโลก", 95, 1900, 6.5, 7400, [16.8211, 100.2659], "WSK", "2026-08-04", "2026-08-06"),
            ],
        },
        ...
        new Manifest
        {
            ...
            Stops =
            [
                Stop("h-7", "DO-2026-0783", "SO-9910203", "zone-9", "นครปฐมค้าส่ง", "อ.เมือง จ.นครปฐม", 55, 850, 3.0, 0, [13.8199, 100.0621], "WPD", "2026-08-03", "2026-08-05"),
                Stop("h-8", "DO-2026-0784", "SO-9910204", "zone-10", "ราชบุรีมาร์ท", "อ.เมือง จ.ราชบุรี", 65, 1000, 3.6, 4900, [13.5282, 99.8134], "WPD", "2026-08-03", "2026-08-05"),
            ],
        },
        ...
        new Manifest
        {
            ...
            Stops =
            [
                Stop("h-1", "DO-2026-0771", "SO-9910190", "zone-7", "ชลบุรี ซูเปอร์มาร์เก็ต", "อ.ศรีราชา จ.ชลบุรี", 160, 3200, 11, 0, [13.1731, 100.9310], "WSK", "2026-08-01", "2026-08-04"),
                Stop("h-2", "DO-2026-0772", "SO-9910191", "zone-8", "ระยองฟู้ดส์", "อ.เมือง จ.ระยอง", 110, 2100, 7.5, 12800, [12.6814, 101.2816], "WSK", "2026-08-01", "2026-08-04"),
            ],
        },
        ...
        new Manifest
        {
            ...
            Stops =
            [
                Stop("h-3", "DO-2026-0765", "SO-9910155", "zone-9", "นครปฐมค้าส่ง", "อ.เมือง จ.นครปฐม", 60, 900, 3.2, 0, [13.8199, 100.0621], "WPD", "2026-07-30", "2026-08-03", status: "delivered"),
                ...
                Stop("h-4", "DO-2026-0766", "SO-9910156", "zone-10", "ราชบุรีมาร์ท", "อ.เมือง จ.ราชบุรี", 70, 1100, 4.0, 5600, [13.5282, 99.8134], "WPD", "2026-07-30", "2026-08-03", status: "delivered", deliverTo: "โรงตัดนอก ราชบุรี (รับของแทนลูกค้า)"),
            ],
        },
        ...
        new Manifest
        {
            ...
            [
                ...
                Stop("h-9", "DO-2026-0786", "SO-9910206", "zone-7", "ชลบุรี ซูเปอร์มาร์เก็ต", "อ.ศรีราชา จ.ชลบุรี", 130, 2600, 8.8, 0, [13.1731, 100.9310], "WWP", "2026-07-30", "2026-08-02", status: "returned"),
                Stop("h-10", "DO-2026-0787", "SO-9910207", "zone-8", "ระยองฟู้ดส์", "อ.เมือง จ.ระยอง", 85, 1700, 5.9, 9100, [12.6814, 101.2816], "WWP", "2026-07-30", "2026-08-02"),
            ],
        },
    ];
    ...
    [
        new() { Id = "msg-1", Direction = "in", System = "OMS", Channel = "SO.Create", Reference = "SO-9910238", At = Seed.At(4, 1, 12), Status = "success", Detail = "รับ SO ใหม่ 1 รายการ" },
        new() { Id = "msg-2", Direction = "in", System = "OMS", Channel = "SO.Create", Reference = "SO-9910237", At = Seed.At(4, 1, 12), Status = "success", Detail = "รับ SO ใหม่ 1 รายการ" },
